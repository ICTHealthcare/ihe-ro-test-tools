...
Class TestTool
   ...
   Public Sub New()
        ...
        brtoGeometricPlannerDataset.ShowDialog()
        ...
        If Not (String.IsNullOrEmpty(brtoGeometricPlannerDataset.tbSelectedImageSet.Text)) Then

            Dim dirInfo As IO.DirectoryInfo = New IO.DirectoryInfo(brtoGeometricPlannerDataset.tbSelectedImageSet.Text)
            ...
            file = new IO.FileInfo(brtoGeometricPlannerDataset.tbSelectedStructset.Text)
            file.CopyTo(path + file.Name, True)
		...
		m_scenarioRunner = New ScenarioRunner(brtoGeometricPlannerDataset.tbSelectedStoragePath.Text)
   End Sub
    ...
    If(imagesFound and structureSetFound and allImagesSameFOR)
    	'run scenario
		m_scenarioRunner.RunScenario(New GeometricPlannerScenario)
